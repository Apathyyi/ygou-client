...
import sy.bishe.ygou.bean.MessageBean;

public class PullMsgAdpater extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PullMsgAdpater(List<MessageBean> data, Context context) {
        this.data = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_pullmsg, parent, false);
                    ...
                    ((ItemViewHolder) holder).button.setOnClickListener(
                            new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    Intent intent = new Intent(context, AddFriendMsgDelegate.class);
